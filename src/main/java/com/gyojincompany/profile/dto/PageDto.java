...
public class PageDto {
	...
	public PageDto(int total, Criteria criteria) {
		...
		//위 식으로 페이지 값이 1~10일때 endPage 값이 10으로 셋팅
		//위 식으로 페이지 값이 11~20일때 endPage 값이 20으로 셋팅
		//위 식으로 페이지 값이 21~30일때 endPage 값이 30으로 셋팅
		...
		// 실제 총 글 수로 계산한 페이지 번호->총 글의 개수가 128개면 13페이지 까지만 출력되어야 함
